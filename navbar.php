  ...
  <body>
    <div class="header" id="topheader">
      <nav class="navbar navbar-expand-lg fixed-top">
          ...
          <a class="navbar-brand font-weight-bold text-white text-uppercase " href="#"><i class="fa fa-bank fa-2x ml-2" style="color:black;"></i>   TSF Bank LTD.</a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto font-weight-bold text-uppercase">
              ...
              <li class="nav-item">
                <a class="nav-link" href="allCustomer.php">Transfer Money</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="history.php">Transaction History</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="index.html/#header-extradiv">Contact Us</a>
              </li>
            </ul>
            </div>
